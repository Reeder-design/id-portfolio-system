...
def main() -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            require("snapshot-band" in rendered and "snapshot-grid" in rendered, "generated project should use the dark shared project snapshot", errors)
            require("case-nav-shell" in rendered and "case-nav" in rendered, "generated project should use the shared flush-top project navigation", errors)
            require("project-story" in rendered, "generated project should use the modern project story structure", errors)
            require("final-stretch-system.css" in rendered, "generated project should load the final shared component stylesheet", errors)
            require("portfolio-motion.js" in rendered, "generated project should inherit shared portfolio motion/hiring support", errors)
            require("project-snapshot-grid" not in rendered, "generated project should not use the retired white snapshot architecture", errors)
            require("project-story-nav-shell" not in rendered, "generated project should not use the retired offset project navigation", errors)
